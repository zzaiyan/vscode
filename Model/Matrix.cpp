...
template<typename FUNC,typename head,typename... T>   //这个函数的作用是，使用第一个参数所表示的函数，来处理后面所有数字
void deal(FUNC func,head _head,T... args){         
    cout<<"共有参数："<<sizeof...(args)<<"个-------"<<_head<<"->"<<func(_head)<<endl;
    deal(func,args...);
}
